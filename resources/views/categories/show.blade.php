    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
            <div class="p-6">
                ...
                <p class="text-gray-600 text-lg">{{ $movies->count() }} films dans cette catégorie</p>
            </div>
        </div>
            ...
            @foreach($movies as $movie)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg transition duration-300 ease-in-out transform hover:scale-105">
                    <a href="{{ route('movies.show', $movie) }}" class="block">
                        ...
                        <div class="p-6">
                            <h3 class="text-xl font-semibold mb-2">{{ $movie->name }}</h3>
                            ...
                            <p class="text-gray-600">Durée: {{ $movie->duration }} min</p>
                            <div class="mt-4">
